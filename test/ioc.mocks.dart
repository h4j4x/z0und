...
class MockConfigService extends _i1.Mock implements _i4.ConfigService {
  ...
  @override
  String? read(String? key) => (super.noSuchMethod(Invocation.method(
        #read,
        [key],
      )) as String?);
}
...
class MockStorageService extends _i1.Mock implements _i5.StorageService {
  ...
  @override
  _i3.Future<bool?> readBool(String? key) => (super.noSuchMethod(
        Invocation.method(
          #readBool,
          [key],
        ),
